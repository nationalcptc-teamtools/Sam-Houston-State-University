...
% Aliases
\newcommand{\faculty}{}
\newcommand{\client}{All Ports Tour}
\newcommand{\cptc}{APT}
\newcommand{\teamname}{Team XX}
\newcommand{\logopath}{images/general/logo.png} %THIS IS THE LOGO FOR THE COMPANY
%\newcommand{\institution}{Team XX2}
\renewcommand{\doctitle}{Security Assessment Report}
...
\setboolean{institutionLogoEnabled}{false}
